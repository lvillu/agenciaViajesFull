...
namespace agenciaViajes.Application.Domain.Repositories
{
    public interface IPaymentRepository
    {
        ...
        Task<int> GetNextFolioNumberAsync(Guid accountId, int folioStart, CancellationToken cancellationToken = default);
        Task<int> GetAccountFolioStartAsync(Guid accountId, CancellationToken cancellationToken = default);
    }
}
