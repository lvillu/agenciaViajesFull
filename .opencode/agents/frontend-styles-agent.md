...
1. Lee `.doc/ola-marina-plan.md` — paleta oficial, tipografía, espaciados, patrones de UI.
...
- **Colores**: primary `#5BA9B3`, backgrounds, textos — deben usar los valores de la paleta oficial.
